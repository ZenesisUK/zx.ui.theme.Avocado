...
qx.Theme.define("zx.ui.theme.avocado.Appearance", {
  appearances: {
    ...
    "gtree-row/arrow": {
      style(states) {
        return {
          source: states.hasChildren
            ? states.opened
              ? zx.ui.theme.avocado.Image.URLS["arrow-down-small"]
              : zx.ui.theme.avocado.Image.URLS["arrow-right-small"]
            : states.selected
            ? zx.ui.theme.avocado.Image.URLS["checkbox-checked"]
            : zx.ui.theme.avocado.Image.URLS["checkbox-blank"]
        };
      }
    },
    ...
    */
    ...
    inlinebutton: {
      style(states) {
        ...
        if (states.selected) textColor += "primary";
        else textColor += "surface";
    ...
    */
    ...
    "accordion-minimap-panel": {
      ...
      style(_, style) {
        style = qx.lang.Object.clone(style ?? {}, true);
        return style;
      }
    },
    ...
    */
    ...
    "line-comparison-cell": {
      style(states) {
        return { minWidth: 816, padding: [0, 0, 0, 16], margin: [8, 0, 0, 0] };
      }
    },
    ...
    */
    ...
    "difference-header-button": {
      ...
      style(state, style) {
        ...
        style.padding = 2;
        if (!state.disabled && state.hovered) style.backgroundColor = "#0002";
    ...
    "difference-header-button/icon": {
      ...
      style(state, style) {
        style = qx.lang.Object.clone(style ?? {});
        if (state.disabled) style.textColor = "primary-disabled";
        else style.textColor = "primary";
